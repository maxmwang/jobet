...
// Source: internal/scraper/scraper.go
...
func (m *MockScraper) Scrape(companyName, site string) ([]Job, error) {
	m.ctrl.T.Helper()
...
func (m *MockScraper) ScrapeAll(companyName string) ([]Job, error) {
	m.ctrl.T.Helper()
